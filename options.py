...
def args_parser():
    ...
    parser.add_argument('--ema_consistency', type=int,
                        default=1, help='whether train baseline model')
    ...
    parser.add_argument('--local_sup_ep', type=int, default=9, help='local supervised epoch')
    parser.add_argument('--local_unsup_ep', type=int, default=1, help='local unsupervised epoch')
    parser.add_argument('--num_users', type=int,
                        default=10, help='local epoch')
    ...
    parser.add_argument('--logdir', type=str,
                        default='./logs/', help='The log file name')
    ...
    parser.add_argument('--dataset', type=str, choices=['cifar10', 'skin', 'SVHN', 'cifar100', 'femnist', 'generated'], default='cifar10',
                        help='dataset used for training')
    parser.add_argument('--datadir', type=str, required=False,
                        default="./data/", help="Data directory")
    parser.add_argument('--model', type=str, default='simple-cnn',
    ...
    # costs
    parser.add_argument('--label_uncertainty', type=str,
                        default='U-Ones', help='label type')
    parser.add_argument('--ema_decay', type=float,
                        default=0.999, help='ema_decay')
    parser.add_argument('--consistency', type=float,
                        default=1, help='consistency')
    parser.add_argument('--consistency_rampup', type=float,
                        default=30, help='consistency_rampup')
    parser.add_argument('--lambda_u', type=float,
                        default=0.02, help='start_epoch')
    ...
    # meta
    parser.add_argument('--meta_round', type=int, default=3,
                        help='number of sub-consensus groups')
    parser.add_argument('--meta_client_num', type=int, default=5,
                        help='number of clients in each sub-consensus group')
    ...
    parser.add_argument('--pre_sz', type=int, default=40,
                        help='image size for pre-processing')
    parser.add_argument('--unsup_num', type=int, default=9,
                        help='number of unsupervised clients')
    ...
    parser.add_argument('--un_dist', default='', type=str,
                        choices=["avg", "prev", "mix"], help='resume from checkpoint')
